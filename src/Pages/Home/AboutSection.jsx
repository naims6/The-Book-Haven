    ...
    <section className="py-16 px-4 md:px-12 lg:px-20">
      <div className="container2 text-center">
        ...
        <p className="text-lg text-text-secondary leading-relaxed max-w-3xl mx-auto mb-12">
          <span className="text-primary font-semibold">The Book Haven</span> is
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-10 max-w-6xl mx-auto">
        {features.map((feature, i) => (
          <div
            key={i}
            className="bg-surface p-6 rounded-2xl shadow-lg hover:-translate-y-2 hover:shadow-blue-500/20 transition-all duration-300"
          >
